...
// Configura o decodificador Draco localmente para descompactar lens.glb
...
export default function FluidGlass({
  ...
  // Direct props like scale, ior, thickness, transmission etc. override baseOverrides
  const directOverrides = {};
  if (scale !== undefined) directOverrides.scale = scale;
  if (ior !== undefined) directOverrides.ior = ior;
  if (thickness !== undefined) directOverrides.thickness = thickness;
  if (transmission !== undefined) directOverrides.transmission = transmission;
  if (roughness !== undefined) directOverrides.roughness = roughness;
  if (chromaticAberration !== undefined) directOverrides.chromaticAberration = chromaticAberration;
  if (anisotropy !== undefined) directOverrides.anisotropy = anisotropy;
  Object.assign(directOverrides, directProps);

  const rawOverrides = { ...baseOverrides, ...directOverrides };
